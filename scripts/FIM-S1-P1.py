...
try:
    ...
    wait(2)
    Studio.SwitchTab(StudioAppPath + "\\Studio_Tab_Model_Blue.png", StudioAppPath + "\\Studio_Tab_Model_White.png")
    Studio.Click_Icon(StudioAppPath, "\\Studio_MeltEntrance_Icon.png", 0)
    Studio.SwitchTab(StudioAppPath + "\\Studio_Tab_Mesh.png", (Pattern(StudioAppPath + "\\Studio_Tab_Mesh_White.png").similar(0.9)))
    ...
    Studio.SwitchTab(StudioAppPath + "\\Studio_Tab_BC_Blue.png", StudioAppPath + "\\Studio_Tab_BC_White.png")
    ...
    #Studio.Click_Icon(StudioAppPath, "\\Btn_ShowModeSelected_MeshShaded2.png", 40)
    Studio.SetMeltInlet("FIM_Runner.png",StudioAppPath)
    Studio.SwitchTab(StudioAppPath + "\\Studio_Tab_Mesh.png", (Pattern(StudioAppPath + "\\Studio_Tab_Mesh_White.png").similar(0.9)))
    Studio.Final_Check(StudioAppPath)
    Log.write_log(ProjectName, "Info: Studio Pre Process Setting is Finished")
    ...
    Studio.SetMeltInlet("FIM_eDesjgn_Runner.png",StudioAppPath)
    Studio.SwitchTab(StudioAppPath + "\\Studio_Tab_Mesh.png", (Pattern(StudioAppPath + "\\Studio_Tab_Mesh_White.png").similar(0.9)))
    Studio.Final_Check(StudioAppPath)
    Log.write_log(ProjectName, "Info: Studio Pre Process Setting is Finished")
    ...
    print( "ENT-FIM-S1-P1 Test is Failed!")
